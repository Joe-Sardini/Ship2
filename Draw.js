...
function drawTriangleUnderMouse(e) {
    //ctx.clearRect(0, 0, canvas.width, canvas.height);
    // the triangle
    ctx.beginPath();
    ctx.moveTo((e.clientX + 30) + deltaX, (e.clientY + 50) + deltaY);
    ctx.lineTo(e.clientX + deltaX, e.clientY + deltaY);
    ctx.lineTo((e.clientX + 60) + deltaX, e.clientY + deltaY);
    ctx.closePath();
